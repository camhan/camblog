...
<head>
    ...
    <style type="text/css">
        body {font-family: "Trebuchet MS", Helvetica, Arial, 'PingFang SC', 'Hiragino Sans GB', 'STHeiti Light', 'Microsoft YaHei', SimHei, 'WenQuanYi Micro Hei', sans-serif;font-size: 12px;margin: 0;color: #000000;background: #ffffff;}
        img {border:0;}
        li {margin-top: 8px;}
...
<center>
    <div style="text-algin: center; font-size: 11px">&copy; <?php echo date('Y'); ?> <a href="<?php bloginfo('url');?>/" style="cursor:help"><?php bloginfo('name');?></a> 版权所有.<br /><br /></div>
</center>
</body>
</html>